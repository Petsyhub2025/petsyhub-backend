...
import { CustomLoggerService, ElasticsearchService, IAreaModel, ModelNames } from '@instapets-backend/common';
import { PipelineStage, Types } from 'mongoose';

@Injectable()
export class AreaIndexHelperService extends BaseIndexHelper {
  ...
  constructor(
    ...
    super(changeStreamTokenUtil, logger, elasticsearchService, areaModel);
    this.esSchema = {
      name: {
        properties: {
          en: {
  ...
  async syncCollection(_ids: string[] = []) {
    ...
    await this.paginationService.paginateAggregate(this.areaModel, matchStage, this.pipeline, async (docs) => {
