...
@Injectable()
export class EventCategoryIndexHelperService extends BaseIndexHelper {
  ...
  constructor(
    ...
    super(changeStreamTokenUtil, logger, elasticsearchService, eventCategoryModel);
    this.esSchema = {
      name: {
        properties: {
          en: {
  ...
  async syncCollection(_ids: string[] = []) {
    ...
    await this.paginationService.paginateAggregate(this.eventCategoryModel, matchStage, this.pipeline, async (docs) => {
