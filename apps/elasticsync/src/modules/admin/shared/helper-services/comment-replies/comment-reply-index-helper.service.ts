...
import { CustomLoggerService, ElasticsearchService, ICommentReplyModel, ModelNames } from '@instapets-backend/common';
import { PipelineStage, Types } from 'mongoose';

@Injectable()
export class CommentReplyIndexHelperService extends BaseIndexHelper {
  ...
  constructor(
    ...
    super(changeStreamTokenUtil, logger, elasticsearchService, commentReplyModel);
    this.esSchema = {
      authorUser: {
        properties: {
          _id: {
  ...
  async syncCollection(_ids: string[] = []) {
    ...
    await this.paginationService.paginateAggregate(this.commentReplyModel, matchStage, this.pipeline, async (docs) => {
