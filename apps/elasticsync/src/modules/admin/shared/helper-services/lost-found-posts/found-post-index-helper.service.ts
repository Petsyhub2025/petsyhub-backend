...
import { CustomLoggerService, ElasticsearchService, IFoundPostModel, ModelNames } from '@instapets-backend/common';
import { Inject, Injectable } from '@nestjs/common';
import { PipelineStage, Types } from 'mongoose';
@Injectable()
export class FoundPostIndexHelperService extends BaseIndexHelper {
  ...
  constructor(
    ...
    super(changeStreamTokenUtil, logger, elasticsearchService, foundPostModel);
    this.esSchema = {
      authorUser: {
        properties: {
          _id: {
  ...
  async syncCollection(_ids: string[] = []) {
    ...
    await this.paginationService.paginateAggregate(this.foundPostModel, matchStage, this.pipeline, async (docs) => {
