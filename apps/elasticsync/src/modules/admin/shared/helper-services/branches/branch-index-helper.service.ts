...
import { CustomLoggerService, ElasticsearchService, IBaseBranchModel, ModelNames } from '@instapets-backend/common';
import { PipelineStage, Types } from 'mongoose';

@Injectable()
export class ServiceProviderBranchIndexHelperService extends BaseIndexHelper {
  ...
  constructor(
    ...
    super(changeStreamTokenUtil, logger, elasticsearchService, baseBranchModel);
    this.esSchema = {
      name: {
        type: 'text',
        fields: {
  ...
  async syncCollection(_ids: string[] = []) {
    ...
    await this.paginationService.paginateAggregate(this.baseBranchModel, matchStage, this.pipeline, async (docs) => {
