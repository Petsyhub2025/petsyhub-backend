...
import { CustomLoggerService, ElasticsearchService, ICommentModel, ModelNames } from '@instapets-backend/common';
import { PipelineStage, Types } from 'mongoose';

@Injectable()
export class CommentIndexHelperService extends BaseIndexHelper {
  ...
  constructor(
    ...
    super(changeStreamTokenUtil, logger, elasticsearchService, commentModel);
    this.esSchema = {
      authorUser: {
        properties: {
          _id: {
  ...
  async syncCollection(_ids: string[] = []) {
    ...
    await this.paginationService.paginateAggregate(this.commentModel, matchStage, this.pipeline, async (docs) => {
