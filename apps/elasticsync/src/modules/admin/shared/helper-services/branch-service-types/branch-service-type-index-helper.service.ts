...
@Injectable()
export class BranchServiceTypeIndexHelperService extends BaseIndexHelper {
  ...
  constructor(
    ...
    super(changeStreamTokenUtil, logger, elasticsearchService, branchServiceTypeModel);
    this.esSchema = {
      name: {
        properties: {
          en: {
