...
import { CustomLoggerService, ElasticsearchService, IDynamicLinkModel, ModelNames } from '@instapets-backend/common';
import { Inject, Injectable } from '@nestjs/common';
import { PipelineStage, Types } from 'mongoose';

@Injectable()
export class DynamicLinksIndexHelperService extends BaseIndexHelper {
  ...
  constructor(
    ...
    super(changeStreamTokenUtil, logger, elasticsearchService, dynamicLinkModel);
    this.esSchema = {
      title: {
        type: 'text',
        fields: {
  ...
  async syncCollection(_ids: string[] = []) {
    ...
    await this.paginationService.paginateAggregate(this.dynamicLinkModel, matchStage, this.pipeline, async (docs) => {
